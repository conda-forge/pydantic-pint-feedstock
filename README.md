...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pydantic-pint-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pydantic-pint-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pydantic-pint
# for installing globally
pixi global install pydantic-pint
```
...
It is possible to list all of the versions of `pydantic-pint` available on your platform:
...
```
pixi search pydantic-pint --channel conda-forge
```
